function toggleMenu() {
  ...
  if (x[0].classList.contains('showMenu') == true) {
	  ...
	  document.getElementsByClassName('dropbutton')[0].classList.add('dropdown_open_style');
  } else {
	  document.getElementById('icon_arrow').src = 'arrow_down.svg';
	  document.getElementsByClassName('dropbutton')[0].classList.remove('dropdown_open_style');
  }
}
